  ...
  return (
    <>
      ...
      <p>
        ...
        of Waving Social's Website, located at waving.es
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Waving if you do not agree to take
      ...
      <p>
        This website does not use cookies. We do not collect any personal data
        through cookies or similar technologies. In the future, if cookies are
        used, we will update this section accordingly and request your consent
        as required by law.
      </p>
      ...
      <p>
        Unless otherwise stated, Waving Social and/or its licensors own the
        intellectual property rights for all material on Waving. All
        intellectual property rights are reserved. You may access this from
        Waving for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        Waving Social does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Waving Social, its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Waving Social
      ...
      <p>
        Waving Social reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Waving Social a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Waving Social; and (d) the link
      ...
      <p>
        ...
        e-mail to Waving Social. Please include your name, your organization
      ...
      <p>
        No use of Waving Social's logo or other artwork will be allowed for
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Waving Social.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Waving Social, accessible from{" "}
            <a
              href="https://waving.es/"
      ...
      <h4>Cookies</h4>
      <p>
        We do not use cookies or any similar tracking technologies on our
        Service.
      </p>
      ...
      <ul>
        <li>By email: isabelsanchezalex@gmail.com</li>
      </ul>
    </>
  );
}
